...
string util::parse_entry(string entry){
    ...
    if(role=="node"){
	  ...
	  if(node_location=="")
            ...
            util::log(".imn batch input file wrong node format!!");
            cout<<".imn batch input file wrong node format!!"<<endl;
            exit(1);
        }
    }
    if(role=="power_line"){
        if(power_line_resistor!="" && power_line_lpeer!="" &&
            ...
            oss<<power_line_resistor<<":"<<power_line_lpeer<<":"<<power_line_rpeer<<":"
             ...
             util::log(".imn batch input file wrong power_line format!!");
            cout<<".imn batch input file wrong node format!!"<<endl;
            exit(1);
        }
    }
     if(role=="power_simulator"){
        if(power_simulator_host!="" && power_simulator_port!="" ){
            oss<<power_simulator_host<<":"<<power_simulator_port;
             ...
             util::log(".imn batch input file wrong power_simulator format!!");
            cout<<".imn batch input file wrong node format!!"<<endl;
            exit(1);
        }
    }
